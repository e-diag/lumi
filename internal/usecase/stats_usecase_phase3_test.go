...
func (r *statsUserRepo) GetByID(context.Context, uuid.UUID) (*domain.User, error) {
	return nil, domain.ErrUserNotFound
}
func (r *statsUserRepo) GetByTelegramID(context.Context, int64) (*domain.User, error) {
	return nil, domain.ErrUserNotFound
}
func (r *statsUserRepo) GetBySubToken(context.Context, string) (*domain.User, error) {
	return nil, domain.ErrUserNotFound
}
...
func (r *statsUserRepo) List(context.Context, string, int, int) ([]*domain.User, int64, error) {
	return nil, 0, nil
}
func (r *statsUserRepo) CountCreatedBetween(context.Context, time.Time, time.Time) (int64, error) {
	return 3, nil
}
...
func (r *statsSubRepo) GetByUserID(context.Context, uuid.UUID) (*domain.Subscription, error) {
	return nil, domain.ErrSubscriptionNotFound
}
func (r *statsSubRepo) ListExpiredBefore(context.Context, time.Time) ([]*domain.Subscription, error) {
	return nil, nil
}
func (r *statsSubRepo) ListExpiringBetween(context.Context, time.Time, time.Time) ([]*domain.Subscription, error) {
	return nil, nil
}
...
func (r *statsSubRepo) CountExpired(context.Context, time.Time) (int64, error) { return 42, nil }

type statsPaymentRepo struct{}

func (r *statsPaymentRepo) Create(context.Context, *domain.Payment) error { return nil }
func (r *statsPaymentRepo) GetByID(context.Context, uuid.UUID) (*domain.Payment, error) {
	return nil, domain.ErrPaymentNotFound
}
func (r *statsPaymentRepo) GetByYookassaID(context.Context, string) (*domain.Payment, error) {
	return nil, domain.ErrPaymentNotFound
}
func (r *statsPaymentRepo) GetByUserID(context.Context, uuid.UUID) ([]*domain.Payment, error) {
	return nil, nil
}
func (r *statsPaymentRepo) ListPendingOlderThan(context.Context, time.Time) ([]*domain.Payment, error) {
	return nil, nil
}
...
func (r *statsPaymentRepo) SumSucceededBetween(context.Context, time.Time, time.Time) (int64, error) {
	return 1000, nil
}
...
func (r *statsPaymentRepo) ConsumePaymentActivation(context.Context, uuid.UUID) (bool, error) {
	return false, nil
}
...
func (r *statsNodeRepo) GetByRegion(context.Context, domain.NodeRegion) ([]*domain.Node, error) {
	return nil, nil
}
func (r *statsNodeRepo) GetByRegionWithTopology(context.Context, domain.NodeRegion) ([]*domain.Node, error) {
	return nil, nil
}
func (r *statsNodeRepo) ListActiveNodeDomains(context.Context) ([]*domain.NodeDomain, error) {
	return nil, nil
}
func (r *statsNodeRepo) UpdateNodeDomain(context.Context, *domain.NodeDomain) error { return nil }
func (r *statsNodeRepo) GetByID(context.Context, uuid.UUID) (*domain.Node, error) {
...
func TestStatsUseCase_GetDashboardStats(t *testing.T) {
	uc := usecase.NewStatsUseCase(&statsUserRepo{}, &statsSubRepo{}, &statsPaymentRepo{}, &statsNodeRepo{}, nil)
